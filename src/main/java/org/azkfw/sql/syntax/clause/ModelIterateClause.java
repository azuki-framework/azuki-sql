 ...
 * </p>
 * <p>
 * <b>model_iterate_clause::=</b>
 * <p><img src="./doc-files/model_iterate_clause.gif"/></p>
 * </p>
 * <p>
 * 有効な例を次に示します。
 * <pre>
 ...
 * @author Kawakicchi
 */
public class ModelIterateClause extends AbstractSyntax{

	public ModelIterateClause() {
	}

	public ModelIterateClause(final int index) {
		super(index);
	}
