 ...
 * </p>
 * <p>
 * <b>hierarchical_query_clause::=</b>
 * <p><img src="./doc-files/hierarchical_query_clause.gif"/></p>
 * </p>
 * <p>
 * 有効な例を次に示します。
 * <pre>
...
public class HierarchicalQueryClause extends AbstractSyntax {
	...
	protected final boolean doAnalyze(final List<Token> tokens, final int offset, final int length) throws SyntaxException {
		...
		if (startsWith(tokens, offset, length, "CONNECT","BY")) {
			trace("未実装");
		} else if(startsWith(tokens, offset, length, "START","WITH", "")) {
			trace("未実装");
		} else {
			return false;
		}
