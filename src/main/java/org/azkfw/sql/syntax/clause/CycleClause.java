 ...
 * <p>
 * <b>cycle_clause::=</b>
 * <p><img src="./doc-files/cycle_clause.gif"/></p>
 * </p>
 * <p>
 * 有効な例を次に示します。
 * <pre>
 * </pre>
 * </p>
 * @see <a href="https://docs.oracle.com/cd/E16338_01/server.112/b56299/statements_9014.htm#i2198448">LINK</a>
 * @author Kawakicchi
 */
public class CycleClause extends AbstractSyntax{

	public CycleClause() {
	}

	public CycleClause(final int index) {
		super(index);
	}
