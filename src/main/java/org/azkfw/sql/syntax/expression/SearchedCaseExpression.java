 ...
 * </p>
 * <p>
 * <b>searched_case_expression::=</b>
 * <p><img src="./doc-files/searched_case_expression.gif"/></p>
 * </p>
 * <p>
 * 有効な例を次に示します。
 * <pre>
 ...
 * @author Kawakicchi
 */
public class SearchedCaseExpression extends AbstractSyntax{

	public SearchedCaseExpression() {
	}
	
	public SearchedCaseExpression(final int index) {
		super(index);
	}
