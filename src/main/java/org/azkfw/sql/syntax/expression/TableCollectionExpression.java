 ...
 * </p>
 * <p>
 * <b>table_collection_expression::=</b>
 * <p><img src="./doc-files/table_collection_expression.gif"/></p>
 * </p>
 * <p>
 * 有効な例を次に示します。
 * <pre>
 * </pre>
 * </p>
 * @see <a href="https://docs.oracle.com/cd/E16338_01/server.112/b56299/statements_9014.htm#i2080063">LINK</a>
 * @author Kawakicchi
 */
public class TableCollectionExpression extends AbstractSyntax{

	public TableCollectionExpression() {
	}
	
	public TableCollectionExpression(final int index) {
		super(index);
	}
