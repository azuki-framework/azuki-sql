 ...
 * </p>
 * <p>
 * <b>simple_case_expression::=</b>
 * <p><img src="./doc-files/simple_case_expression.gif"/></p>
 * </p>
 * <p>
 * 有効な例を次に示します。
 * <pre>
 ...
 * @author Kawakicchi
 */
public class SimpleCaseExpression extends AbstractSyntax{

	public SimpleCaseExpression() {
	}
	
	public SimpleCaseExpression(final int index) {
		super(index);
	}
