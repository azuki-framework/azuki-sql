 ...
 * </p>
 * <p>
 * <b>analytic_function::=</b>
 * <p><img src="./doc-files/analytic_function.gif"/></p>
 * </p>
 * <p>
 * 有効な例を次に示します。
 * <pre>
 * </pre>
 * </p>
 * @see <a href="https://docs.oracle.com/cd/E16338_01/server.112/b56299/functions004.htm#i81407">LINK</a>
 * @author Kawakicchi
 */
public class AnalyticFunction extends AbstractSyntax{

	public AnalyticFunction() {
	}
	
	public AnalyticFunction(final int index) {
		super(index);
	}
