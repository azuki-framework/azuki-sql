 ...
 * </p>
 * <p>
 * <b>user_defined_function::=</b>
 * <p><img src="./doc-files/user_defined_function.gif"/></p>
 * </p>
 * <p>
 * 有効な例を次に示します。
 * <pre>
 * </pre>
 * </p>
 * @see <a href="https://docs.oracle.com/cd/E16338_01/server.112/b56299/functions256.htm#i1012049">LINK</a>
 * @author Kawakicchi
 */
public class UserDefinedFunction extends AbstractSyntax{

	public UserDefinedFunction() {
	}
	
	public UserDefinedFunction(final int index) {
		super(index);
	}
