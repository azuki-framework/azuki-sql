 ...
 * </p>
 * <p>
 * <b>single_column_for_loop::=</b>
 * <p><img src="./doc-files/single_column_for_loop.gif"/></p>
 * </p>
 * <p>
 * 有効な例を次に示します。
 * <pre>
 ...
 * @author Kawakicchi
 */
public class SingleColumnForLoop extends AbstractSyntax{

	public SingleColumnForLoop() {
	}
	
	public SingleColumnForLoop(final int index) {
		super(index);
	}
