 ...
 * </p>
 * <p>
 * <b>cell_reference_options::=</b>
 * <p><img src="./doc-files/cell_reference_options.gif"/></p>
 * </p>
 * <p>
 * 有効な例を次に示します。
 * <pre>
 ...
 * @author Kawakicchi
 */
public class CellReferenceOptions extends AbstractSyntax{

	public CellReferenceOptions() {
	}
	
	public CellReferenceOptions(final int index) {
		super(index);
	}
