 ...
 * @author Kawakicchi
 */
public class MultiLineCommentTokenPattern extends CommentTokenPattern {

	private boolean endFlag;
	
	public MultiLineCommentTokenPattern() {
		
	}

	protected MultiLineCommentTokenPattern(final String name) {
		super(name);
	}
