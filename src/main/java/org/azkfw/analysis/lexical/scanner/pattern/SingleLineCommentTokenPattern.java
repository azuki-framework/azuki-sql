 ...
 * @author Kawakicchi
 */
public class SingleLineCommentTokenPattern extends CommentTokenPattern {
	
	public SingleLineCommentTokenPattern() {
		
	}

	protected SingleLineCommentTokenPattern(final String name) {
		super(name);
	}
